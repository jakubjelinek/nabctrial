...
\gregallchar{cl>ppt2}\quad), torculus resupinus with celeriter on it
{\color{red}{\textsuperscript{c}}\gregallmodchar{tr}}\quad, torculus resupinus with
...
the diminut. porrectus \gregallchar{po~}\quad, diminut. torculus resupinus
...
For some of the shape modifications of torculus and torculus resupinus, I'm
...
Similarly the 2nd shape modified torculus resupinus, SGModern has
\gregallmodchar{trS1}\quad, what I found in the MSS is \gregallchar{trS1}\quad, but not sure
if it is the same neume.  For the 3rd shape modified torculus resupinus,
I'm not sure what is the difference from the plain torculus resupinus
